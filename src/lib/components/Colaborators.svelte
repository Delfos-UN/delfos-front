<script lang="ts">
	...
	const handleSubmit = async (e: Event) => {
		...
		try {
			const response = await guardarColaborador(name, email, github, area, message);
...
>
    <div class="min-h-[25vh]">
        ...
        <p class="mb-4 text-lg text-[#e0e4e2]">
            ...
            Buscamos mentes creativas y apasionadas que estén dispuestas a compartir su talento y compromiso
            para impulsar el desarrollo y construir un futuro mejor. Si estás listo para aceptar el desafío
            y ser parte de una comunidad que valora la innovación y el trabajo en equipo, te invitamos a
            unirte a nosotros. ¡Juntos, podemos hacer la diferencia!
        </p>
    </div>
	<div class="min-h-[25vh]">
	...
	<div class="min-h-[50vh]">
        ...
        <p class="mb-4 text-lg text-[#e0e4e2]">
            ...
            saber de ti. Estamos siempre abiertos a nuevas propuestas y colaboraciones que impulsen nuestro
            proyecto. Por favor, no dudes en ponerte en contacto con nosotros para discutir cómo podemos
            trabajar juntos.
        </p>
        <div class="flex justify-center">
            <form on:submit={handleSubmit} class="w-full max-w-lg space-y-4">
                ...
                <div>
                    <label for="message" class="block text-[#e0e4e2]">¿Cómo y por qué te gustaría aportar?</label>
                    <textarea
                        id="message"
                        bind:value={message}
